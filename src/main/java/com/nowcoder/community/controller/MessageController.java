    ...
    public String getNoticeDetail(@PathVariable("topic") String topic, Model model, Page page) {
        ...
        if (noticeVoList != null) {
            for (Message notice : noticeList) {
                ...
                Map<String, Object> data = JSONObject.parseObject(content, HashMap.class);
                m.put("user", userService.findUserById((Integer) data.get("userId")));
                m.put("entityType", data.get("entityType"));
                m.put("entityId", data.get("entityId"));
                m.put("postId", data.get("postId"));
                //通知作者
                m.put("fromUser", userService.findUserById(notice.getFromId()));
                noticeVoList.add(m);
            }
        }
